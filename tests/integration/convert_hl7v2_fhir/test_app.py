...
def test_lambda_handler__invalid_nhs_num_AR(mocker):
    mocker.patch('app._send_to_sqs')
    # given
    resp = lambda_handler(_create_lambda_body(msg_invalid_nhs_no), _create_dummy_context())
    msg = parse(resp["body"])
    # test
...
def test_lambda_handler__missing_nhs_num_AR(mocker):
    mocker.patch('app._send_to_sqs')
    # given
    resp = lambda_handler(_create_lambda_body(msg_missing_nhs_no), _create_dummy_context())
    msg = parse(resp["body"])
    # test
    assert msg["MSA"][0][1][0] == "AR"
...
def test_lambda_handler__missing_segment(mocker):
    mocker.patch('app._send_to_sqs')
    # given
    resp = lambda_handler(_create_lambda_body(msg_missing_segment), _create_dummy_context())
    msg = parse(resp["body"])
    # test
    assert msg["MSA"][0][1][0] == "AR"
...
def test_lambda_handler__missing_field(mocker):
    mocker.patch('app._send_to_sqs')
    # given
    resp = lambda_handler(_create_lambda_body(msg_missing_field), _create_dummy_context())
    msg = parse(resp["body"])
    # test
    assert msg["MSA"][0][1][0] == "AR"
